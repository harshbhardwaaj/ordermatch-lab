  ...
  return (
    <AppShell>
      ...
      >
        ...
        {/* Act two. The problem above is theirs; this is the answer, and it is
            the thing worth reading, so it gets the page rather than a link. */}
        <section className="mt-20 flex w-full flex-col gap-8 border-t border-[var(--om-border)] pt-14">
          <div>
